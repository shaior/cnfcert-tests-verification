...
var _ = Describe("lifecycle-liveness", func() {
	...
	It("One deployment, one pod with a liveness probe", func() {
		...
		err = globalhelper.LaunchTests(lifeparameters.TnfLivenessTcName,
			globalhelper.ConvertSpecNameToFileName(CurrentGinkgoTestDescription().FullTestText))
		Expect(err).ToNot(HaveOccurred())

		By("Verify test case status in Junit and Claim reports")
		err = globalhelper.ValidateIfReportsAreValid(lifeparameters.TnfLivenessTcName,
	...
	It("One statefulSet, one pod with a liveness probe", func() {
		...
		statefulset := statefulset.RedefineWithLivenessProbe(lifehelper.DefineStatefulSet("lifecycle-sf"))
	...
	It("One pod with a liveness probe", func() {
		...
		pod := pod.RedefineWithLivenessProbe(pod.RedefinePodWithLabel(lifehelper.DefinePod("lifecycleput"),
